...
# 1. Upload test_urllib_resend.py
url = f"https://www.pythonanywhere.com/api/v0/user/{USERNAME}/files/path/home/{USERNAME}/test_urllib_resend.py"
with open(os.path.join(base_dir, "test_urllib_resend.py"), "rb") as f:
...
if consoles:
    ...
    requests.post(send_url, headers=headers, json={"input": "cd /home/MediNEXA && python test_urllib_resend.py\n"})
    time.sleep(5)
